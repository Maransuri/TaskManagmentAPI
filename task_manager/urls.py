...
urlpatterns = [
    ...
    path('', home_view),  # ✅ Homepage message
    ...
    path('api/token/', TokenObtainPairView.as_view(), name='token_obtain_pair'),  # ✅ JWT Token Login
    path('api/token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),  # ✅ JWT Token Refresh
]

# ✅ Add Django Debug Toolbar support in DEBUG mode
if settings.DEBUG:
